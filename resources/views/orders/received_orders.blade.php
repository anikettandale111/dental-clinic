            ...
            <tbody>
                ...
                @foreach($my_orders as $k =>$v)
                    <tr>
                        ...
                        <td>
                            @if($v['order_status']==0)
                                <button class="btn btn-info" data-toggle="modal" data-target=".bd-example-modal-lg" onclick="viewOrders('<?=$v['order_id']?>')">View</button>
        ...
        <div class="row">
          ...
          <div class="col-xl-4">
            ...
            <p class="text-black float-start"><span class="text-black me-3"> Total Amount</span><span
                style="font-size: 20px;" class="grand_total"></span></p>
          </div>
        </div>
        <hr>
        <!-- <div class="row">
