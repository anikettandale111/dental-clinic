...
class OrderController extends Controller
{
    ...
    {
        if(isset($request->order_id) && $request->order_id == "dispatch"){
            ...
            ->where('tbl_dispatch.order_id',$request->order_id)
            ->orderBy('tbl_dispatch.id')->get();
